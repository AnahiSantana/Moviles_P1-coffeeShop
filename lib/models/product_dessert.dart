...
enum ProductPortion { INDIVIDUAL, FAMILIAR }
...
class ProductDessert {
  ...
  ProductPortion productPortion; // tamano del producto
  ...
  double productPriceCalculator() {
    if (this.productPortion == ProductPortion.INDIVIDUAL)
      return (15 + Random().nextInt(10)).toDouble();
    if (this.productPortion == ProductPortion.FAMILIAR)
